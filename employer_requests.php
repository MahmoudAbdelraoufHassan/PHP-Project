                    ...
                    <div class="jobs">
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <div class="box bg-white rounded-3 position-relative">
                                ...
                                <span class="d-flex flex-wrap flex-column"
                                    style="width:100% ; align-items:end; justify-content:flex-start;">
                                    <a href="reject.php?id=<?php echo $row['applicant_id']; ?>&id_job=<?php echo $row['listing_id']; ?>"
                                        class="btn bg-danger border-none"
                                        style="background-color: red ; color:white ; ">Reject</a>
